...
export default function HeroAdmin() {
  ...
  useEffect(() => {
    fetch("https://rehabserver.onrender.com/hero")
      .then((res) => res.json())
  ...
  const handleUpload = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    const res = await fetch("https://rehabserver.onrender.com/hero/upload", {
      method: "POST",
      body: formData,
    });
    ...
    if (data.success) {
      ...
      const res2 = await fetch("https://rehabserver.onrender.com/hero");
