...
export default function DashboardPage() {
  ...
  useEffect(() => {
    ...
    const fetchAppointments = async () => {
      try {
        const res = await fetch(
          "https://rehabserver.onrender.com/upcoming-appointments"
        );
    ...
    const fetchAnalytics = async () => {
      try {
        const res = await fetch(
          "https://rehabserver.onrender.com/analytics/visits-summary"
        );
        const data = await res.json();
  ...
  useEffect(() => {
    const fetchUnreadCount = async () => {
      try {
        const res = await fetch(
          "https://rehabserver.onrender.com/contacts/unread-count"
        );
        const data = await res.json();
    ...
    <div className="flex flex-col gap-8">
      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-5">
        <Card className="col-span-1 lg:col-span-3">
          <CardHeader>
            ...
            <CardDescription>
              A look at which services are getting the most attention.
            </CardDescription>
          </CardHeader>
          <CardContent>
            {chartData.length > 0 ? (
        ...
        <Card className="col-span-1 lg:col-span-2">
          ...
          <CardContent className="grid gap-2">
            ...
            <Button asChild variant="secondary">
              <Link href="/gallery">
                <ImageIcon /> Add Image to Gallery
              </Link>
            </Button>
            <Button asChild variant="secondary">
              <Link href="/messages">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            A summary of appointments scheduled for the next 7 days.
          </CardDescription>
        </CardHeader>
        <CardContent>
          <Table>
